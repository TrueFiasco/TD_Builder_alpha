...
| Validate a `.toe.dir` before importing | `python "Tools/offline Builder tools/td_validate.py" <path>` | 7-stage validator; catches mode-0/17 parm issues and orphan refs |
